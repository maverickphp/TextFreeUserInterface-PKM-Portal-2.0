        ...
        <form className="mx-1 mx-md-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="d-flex flex-row align-items-center mb-4">
                <div className="form-outline flex-fill mb-0">
                    {errors?.name?.type && <p style={{ color: "red" }}>Name is required</p>}
                    <input
            ...
            <div className="d-flex flex-row align-items-center mb-4">
                <div className="form-outline flex-fill mb-0">
                    {errors?.email?.type && <p style={{ color: "red" }}>Email is required</p>}
            ...
            <div className="d-flex flex-row align-items-center mb-4">
                <div className="form-outline flex-fill mb-0">
                    ...
                    {errors?.password?.type === "minLength" && <p style={{ color: "red" }}>Password should be at least 8 characters</p>}
                    <input
                        type="password"
                        id="form3Example4c"
                        className="form-control"
            ...
            <div className="d-flex flex-row align-items-center mb-4">
                <div className="form-outline flex-fill mb-0">
                    {errors?.confirm_password?.type === "required" && <p style={{ color: "red" }}>This feild is required</p>}
                    {errors?.confirm_password?.type === "validate" && <p style={{ color: "red" }}>Your passwords do no match</p>}
                    <input
                        type="password"
                        id="form3Example4cd"
                        className="form-control"
